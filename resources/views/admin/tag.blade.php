          ...
          <div class="card">
              ...
              <div class="button-action">
                <ul class="list-inline">
                  <li class="list-inline-item"><button class="btn btn-primary trigger" data-iziModal-open="#modal-add">Create Tag</button></li>
                </ul>
              </div>
                                ...
                                <td class="text-center">
                                  <ul class="list-inline">
                                    ...
                                    <li class="list-inline-item">
                                      <form method="post" action="{{url('admin/tag/delete')}}">
...
<!-- modal -->
<div id="modal-add" class="iziModal" data-izimodal-title="Create Tag" data-izimodal-subtitle="create kategori">
        ...
        <div class="row">
          ...
          <div class="col-sm-4">
            <select name="status" class="form-control">
              <option value="">-Status Tag-</option>
...
<div id="modal-edit" class="iziModal" data-izimodal-title="Edit Tag" data-izimodal-subtitle="edit kategori">
  ...
  <div class="container">
    ...
    <div class="modal-body">
      <form method="post" action="{{url('admin/tag/edit')}}">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
